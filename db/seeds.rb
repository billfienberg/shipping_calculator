...
# Create TransitTimes
TransitTime.create(carrier_id:1, origin_id:1, destination_id:4,number_of_days:2)
TransitTime.create(carrier_id:1, origin_id:1, destination_id:5,number_of_days:1)
TransitTime.create(carrier_id:1, origin_id:1, destination_id:6,number_of_days:3)
TransitTime.create(carrier_id:2, origin_id:1, destination_id:4,number_of_days:3)
TransitTime.create(carrier_id:2, origin_id:1, destination_id:6,number_of_days:1)
TransitTime.create(carrier_id:2, origin_id:1, destination_id:7,number_of_days:2)
TransitTime.create(carrier_id:3, origin_id:1, destination_id:5,number_of_days:2)
TransitTime.create(carrier_id:3, origin_id:1, destination_id:8,number_of_days:2)
TransitTime.create(carrier_id:3, origin_id:1, destination_id:10,number_of_days:3)
TransitTime.create(carrier_id:4, origin_id:1, destination_id:6,number_of_days:4)
TransitTime.create(carrier_id:4, origin_id:1, destination_id:8,number_of_days:3)
TransitTime.create(carrier_id:4, origin_id:1, destination_id:9,number_of_days:2)
...
DestinationHoliday.create(destination_id:5,holiday_id:1)
DestinationHoliday.create(destination_id:5,holiday_id:2)
DestinationHoliday.create(destination_id:5,holiday_id:4)
DestinationHoliday.create(destination_id:5,holiday_id:6)
DestinationHoliday.create(destination_id:6,holiday_id:2)
DestinationHoliday.create(destination_id:6,holiday_id:3)
DestinationHoliday.create(destination_id:6,holiday_id:5)
DestinationHoliday.create(destination_id:6,holiday_id:7)
DestinationHoliday.create(destination_id:7,holiday_id:4)
DestinationHoliday.create(destination_id:7,holiday_id:6)
DestinationHoliday.create(destination_id:7,holiday_id:8)
DestinationHoliday.create(destination_id:7,holiday_id:10)
